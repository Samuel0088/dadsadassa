...
const BusMap = () => {
  ...
  const lines = {
    "102": {
      label: "102 - Jd. Brasil / Pq. Novo Mundo",
      points: [
        [-22.714028489466486, -47.293826782998735],
        [-22.774735645162547, -47.34530237526542],
      ]
    },
    "220": {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '900px', margin: '0 auto' }}>
      <h2 style={{ fontSize: '40px', fontWeight: 'bold', marginBottom: '20px' }}>
        Linhas Municipais - <span style={{ color: 'yellow' }}>Sou</span>, Americana/SP
      </h2>
      ...
      <div style={{ marginBottom: '20px' }}>
        ...
        >
          ...
          <option value="102">102 - Jd. Brasil / Novo Mundo</option>
          <option value="103">103 - Jd. Brasil / Antônio Zanaga / Alabama</option>
          <option value="104">104 - Bertini / Alabama / Mathiensen</option>
          <option value="105">105 - Bertini / Jd. Alvorada</option>
          <option value="106">106 - Jd. Bertoni / Terminal</option>
          <option value="107">107 - São Roque / Parque das Nações / Bertoni</option>
          <option value="108">108 - Bertini / Cariobinha / Terminal</option>
          <option value="111">111 - Portal dos Nobres / Iate / Terminal</option>
          <option value="112">112 - Mathiesen / Antônio Zanaga</option>
          <option value="114">114 - Morada do Sol / Terminal</option>
          <option value="116">116 - Mathiesen / Novo Mundo / Jd. Alvorada</option>
          <option value="117">117 - Antônio Zanaga / Novo Mundo</option>
          <option value="118">118 - Parque Liberdade / Praia dos Namorados / Jd. Asta</option>
          <option value="119">119 - Jd. Brasília / Praia Recanto via Av. Brasil</option>
          <option value="200">200 - Jd. Brasília / Praia Azul via Av. Campos Sales</option>
          <option value="205">205 - Jd. Brasília / Antônio Zanaga via Av. Brasil</option>
          <option value="206">206 - Jd. da Paz / Terminal</option>
          <option value="208">208 - Jd. da Paz / Antônio Zanaga</option>
          <option value="211">211 - Jd. da Paz / Jd. da Paz / Werner Plass via Av. Campos Sales</option>
          <option value="212">212 - Jd. da Paz / Praia Azul via Rio Branco</option>
          <option value="213">213 - Jd. da Balsa / Hospital Municipal</option>
          <option value="220">220 - Mário Covas / Praia Recanto via Av. Campos Sales</option>
          <option value="224">224 - Jardim Bôer / Terminal</option>
          <option value="225">225 - Mathiesen / Praia Recanto</option>
        </select>
      </div>
